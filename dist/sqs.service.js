...
let SqsService = class SqsService {
    ...
    onModuleInit() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            this.logger = (_a = this.options.logger) !== null && _a !== void 0 ? _a : new common_1.Logger('SqsService', { timestamp: false });
            ...
            (_b = this.options.consumers) === null || _b === void 0 ? void 0 : _b.forEach((options) => {
                ...
                const consumer = Array.from(Array((_a = consumerOptions.jobCount) !== null && _a !== void 0 ? _a : 1)).map(() => sqs_consumer_1.Consumer.create(Object.assign(Object.assign({}, consumerOptions), (isBatchHandler
                    ? {
                        handleMessageBatch: metadata.discoveredMethod.handler.bind(metadata.discoveredMethod.parentClass.instance),
                    }
                    : { handleMessage: metadata.discoveredMethod.handler.bind(metadata.discoveredMethod.parentClass.instance) })))).reduce((acc, value) => acc.concat(value), []);
                const eventsMetadata = eventHandlers.filter(({ meta }) => meta.name === name);
                for (const eventMetadata of eventsMetadata) {
                    if (eventMetadata) {
                        consumer.forEach((c) => c.addListener(eventMetadata.meta.eventName, eventMetadata.discoveredMethod.handler.bind(metadata.discoveredMethod.parentClass.instance)));
                    }
                }
                this.consumers.set(name, consumer);
            });
            (_c = this.options.producers) === null || _c === void 0 ? void 0 : _c.forEach((options) => {
